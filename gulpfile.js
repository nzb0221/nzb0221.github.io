...
gulp.task('css-core', () => gulp.src([
    'css/reveal.scss',
    'node_modules/reveal-run-in-terminal/static/plugin/reveal-run-in-terminal.css'
])
    .pipe(compileSass())
    .pipe(autoprefixer())
...
gulp.task('package', gulp.series('default', () =>
    ...
    gulp.src([
        ...
        './plugin/**',
        './**.md'
    ]).pipe(zip('txm-presentations.zip')).pipe(gulp.dest('./build'))
